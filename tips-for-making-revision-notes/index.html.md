---
title: "Awesome Tips for Making Revision Notes ..."
...
Flashcards are a great format for revision notes because their size means that only vital information can be stored on them, and their travel size nature means that you can pretty much take them anywhere with you to grab a few minutes of revision on the go at short notice.

## 3. Learn as You Write

Even the process of making revision notes means that you are going to be learning as you write, and then at the end of the creation process, you will have a nice shiny set of notes that you can keep referring back to as you reinforce your learning.

## 4. Not a Memory Test

It is important to remember that revision should be a straight up memory test. It’s not about learning lines and lines of textbooks to be able to regurgitate them on an exam paper. Instead, you should be committing key themes and facts to your memory so that when you get to the exam paper, you will be able to craft a strong piece of writing that has all of these key points as its spine.

## 5. Start Early

There is no such thing as starting too early when it comes to making revision notes. You can only take in so much information at once, so the earlier you start, the more information you will be able to store.
...
- [HTML article](https://teen.allwomenstalk.com/tips-for-making-revision-notes/)
